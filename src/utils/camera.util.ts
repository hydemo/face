...
export class CameraUtil {
  ...
  */
  ...
  async getImg(url: string): Promise<string> {
    const result: any = await axios.get(`${this.config.qiniuLink}/${url}?imageMogr2/auto-orient/thumbnail/800x/gravity/Center/crop/800x800/blur/1x0/quality/85|imageslim`, { responseType: 'arraybuffer' })
